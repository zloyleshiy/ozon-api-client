...
[![Coverage Status](https://coveralls.io/repos/github/zloyleshiy/ozon-api-client/badge.svg)](https://coveralls.io/github/zloyleshiy/ozon-api-client)
![example workflow](https://github.com/zloyleshiy/ozon-api-client/actions/workflows/tests.yml/badge.svg)
...
```bash
go get github.com/zloyleshiy/ozon-api-client
```
...
import (
	...
	"github.com/zloyleshiy/ozon-api-client/ozon"
)
...
import (
	...
	"github.com/zloyleshiy/ozon-api-client/ozon/notifications"
)
